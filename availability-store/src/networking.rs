...
use crate::attestation::{View as AttestationView, PeerData as AttestationPeerData};
...
impl RegisteredMessageValidator {
	...
	pub fn register_availability_store(&self, availability_store: crate::Store) {
...
impl MessageValidationData {
	...
	pub fn check_statement(&self, relay_chain_leaf: &Hash, statement: &SignedStatement) -> Result<(), ()> {
